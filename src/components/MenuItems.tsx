  ...
  return (
    <div className={styles.menu}>
      ...
      <ul className={styles.autor}>
        ...
        <li><a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/thiago-furtado-silva/"> LinkedIn </a></li>
        <li><a target="_blank" rel="noreferrer" href="https://github.com/th1ag0-Zz"> GitHub </a></li>
        <li><a target="_blank" rel="noreferrer" href="https://www.instagram.com/thiag0_dev/"> Instagram </a></li>
      </ul>
    </div>
  )
}